/CWD,'D:\CodeSave\GitCode\Topology-optimization-of-structure-via-simp-methodNEW\ANSYS\results'  
RESUME,'complex2D_grid','db','D:\CodeSave\GitCode\Topology-optimization-of-structure-via-simp-methodNEW\ANSYS\models',0,0   
/FILENAME,top2d,1   
/TITLE,top2d
...
*CFOPEN,testout,txt 
*VWRITE,MATERIAL(1,1),MATERIAL(1,2) 
(E14.7,E15.7)   
*CFCLOS 
